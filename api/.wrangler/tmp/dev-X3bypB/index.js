...
// .wrangler/tmp/bundle-4t8Hhm/strip-cf-connecting-ip-header.js
...
// src/services/lp-analysis/lp-fetcher.ts
var MAX_URL_LENGTH = 2e3;
var LP_HTML_SLICE = 15e3;
var FETCH_TIMEOUT_MS = 15e3;
var URL_REGEX = /^https?:\/\/[^\s]+$/i;
function isUrl(input) {
  const trimmed = input.trim();
  return trimmed.length <= MAX_URL_LENGTH && URL_REGEX.test(trimmed);
}
__name(isUrl, "isUrl");
async function getLpContent(lpInput, fetchImpl) {
...
__name(getLpContent, "getLpContent");
...
// src/services/lp-analysis/llm.ts
var OPENAI_CHAT_URL = "https://api.openai.com/v1/chat/completions";
var MODEL = "gpt-4o-mini";
var MAX_TOKENS = 4096;
async function analyzeLpWithLlm(content, apiKey, fetchImpl) {
  if (!apiKey) {
    return { markdown: "", error: "OPENAI_API_KEY is not set" };
  }
  const userMessage = content.length > 0 ? `\u4EE5\u4E0B\u304CLP\u306E\u5185\u5BB9\u3067\u3059\u3002\u6307\u5B9A\u30D5\u30A9\u30FC\u30DE\u30C3\u30C8\u3067\u5206\u6790\u7D50\u679C\u3092Markdown\u3067\u51FA\u529B\u3057\u3066\u304F\u3060\u3055\u3044\u3002

---

${content}` : "LP\u306E\u5185\u5BB9\u304C\u7A7A\u3067\u3059\u3002\u5165\u529B\u3055\u308C\u305FURL\u306B\u30A2\u30AF\u30BB\u30B9\u3067\u304D\u306A\u304B\u3063\u305F\u53EF\u80FD\u6027\u304C\u3042\u308A\u307E\u3059\u3002";
  const body = {
    model: MODEL,
    max_tokens: MAX_TOKENS,
    messages: [
      { role: "system", content: LP_ANALYSIS_SYSTEM_PROMPT },
...
__name(analyzeLpWithLlm, "analyzeLpWithLlm");

// src/config.ts
var ENV_OPENAI_API_KEY = "OPENAI_API_KEY";
var MAX_LP_INPUT_LENGTH = 5e4;

// src/routes/lp-analysis/lp-analysis.ts
var lpAnalysisRoutes = new Hono2().post("/lp-analysis", async (c) => {
  let body;
  try {
  ...
  if (!lpInput.trim()) {
    return c.json({ ok: false, error: "lpInput is required" }, 400);
  }
  ...
  if (fetchError) {
    return c.json({ ok: false, error: fetchError }, 422);
  }
  const { markdown, error: llmError } = await analyzeLpWithLlm(content, apiKey, fetch);
  if (llmError) {
    return c.json({ ok: false, error: llmError }, 502);
  }
...
// .wrangler/tmp/bundle-4t8Hhm/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-4t8Hhm/middleware-loader.entry.ts
